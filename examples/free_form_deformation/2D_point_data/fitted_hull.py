...
plt.show()
fig.savefig('fitted_config.svg', bbox_inches='tight')
...
ax.set_aspect('equal', adjustable="datalim")
plt.show()
fig.savefig('fitted_opt_Ps.svg', bbox_inches='tight')
...
ax.set_aspect('equal', adjustable="datalim")
plt.show()
fig.savefig('fitted_opt_Ps_Gs.svg', bbox_inches='tight')
